            ...
            <div className="container">
                ...
                <div className={classes.footer_logos}>
                    <div className={classes.social}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="299" width="166.1" viewBox="0 0 166.1 299">
                            <path fill="#FFF"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="299.4" width="368.4"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="200" width="200" viewBox="-589 1042.5 200 200">
                            <path fill="#FFF"
